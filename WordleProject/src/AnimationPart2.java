...
public class AnimationPart2 {
	...
	public AnimationPart2() throws IOException 
	{
		JFrame frame = new JFrame("CONGRATS " + TwoPlayerIntro.SecondPlayer.getName().toUpperCase() + " YOU WON THE GAME!");
	...
	public class Balls extends JPanel
	{
		public Balls() throws IOException 
		{
            ...
            JLabel jScore = new JLabel("Your score is: " + TwoPlayerIntro.SecondPlayer.score);
