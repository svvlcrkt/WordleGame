...
public class IntroPart extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == jbdragDrop) {
			WordleGameDD wd = new WordleGameDD();
			setVisible(false);
		}
		if (e.getSource() == jbkeyboard) {
			WordleGameK wk = new WordleGameK();
			setVisible(false);
		}
		if (e.getSource() == statistics) {
			StatisticsforOne s = new StatisticsforOne();
