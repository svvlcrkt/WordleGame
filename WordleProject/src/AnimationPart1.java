...
public class AnimationPart1 {
	...
	public AnimationPart1() throws IOException 
	{
		JFrame frame = new JFrame("CONGRATS " + TwoPlayerIntro.FirstPlayer.getName().toUpperCase() + " YOU WON THE GAME!");
	...
	public class Balls extends JPanel
	{
		public Balls() throws IOException 
		{
            ...
            JLabel jScore = new JLabel("Your score is: " + TwoPlayerIntro.FirstPlayer.score);
